...
const ProjectCard: React.FC<{
  ...
  return (
    <div className="w-full border-b border-[#D7E2EA]/10 pb-16 sm:pb-24 last:border-b-0 last:pb-0">
      {/* Main Two-Column Content Layout */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 items-center w-full">
        {/* Left Column (Text & Editorial Details) */}
        <div className="lg:col-span-6 flex flex-col gap-6 text-left">
          ...
          <div className="flex items-center gap-4 w-full">
            ...
            <span className="text-xs uppercase tracking-widest text-[#8FA3AE] font-mono font-semibold shrink-0">
              {project.category}
            </span>
          </div>

          {/* Elegant Display Title */}
          <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-[2.65rem] text-[#D7E2EA] font-bold leading-[1.15] tracking-tight font-display">
            {project.title}
          </h3>

          {/* Description Paragraph */}
          <p className="font-light leading-relaxed text-[#D7E2EA]/85 text-base sm:text-lg md:text-xl max-w-xl font-sans">
            {project.description}
          </p>
        ...
        {/* Right Column (Framed Visual Architecture Diagram) */}
        <div className="lg:col-span-6 w-full flex flex-col justify-center gap-3">
